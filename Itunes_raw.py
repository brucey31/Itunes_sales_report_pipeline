...
while start_date_3 <= end_date_3:
    ...
    if len(rs) > 1:
        ...
        call(["java", "-jar", "Reporter.jar", "p=Reporter.properties", "Sales.getReport", "80082574,", "Sales,", "Summary,", "Daily,", "%s" % start_date_3.strftime("%Y%m%d")])
...
while start_date_4 <= end_date_4:
    ...
    if len(rs) > 1:
        ...
        call(["java", "-jar", "Reporter.jar", "p=Reporter.properties", "Sales.getReport", "80082574,", "Sales,", "Summary,", "Daily,", "%s" % start_date_4.strftime("%Y%m%d")])
